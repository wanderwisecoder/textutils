    ...
    <>
      <div className='container' style={{ color: prop.mode === 'dark' ? 'white' : '#042743' }}>
        ...
        <div className="mb-3">
          <textarea
            ...
            rows="8"
            value={text}
            onChange={handleOnChange} style={{ backgroundColor: prop.mode === 'dark' ? '#042743' : 'white', color: prop.mode === 'dark' ? 'white' : '#042743' }}
          ></textarea>
        </div>
      ...
      <div className="container my-3" style={{ color: prop.mode === 'dark' ? 'white' : '#042743' }}>
        ...
        <button disabled={text.length === 0}
          type="button"
          className="btn btn-primary mx-1 mb-4" id="myBox"
        ...
        <p>
          It will take {0.008 * (text.split(/\s+/).filter((element) => { return element.length !== 0 }).length)} minutes to reade
          the above text.
        </p>
        <h2>Preview</h2>
